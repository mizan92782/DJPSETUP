"""
configuration/models/stripe_config_mod.py — Stripe Configuration Model

Singleton model to store Stripe payment configuration.
Merged from the stripe_config app.
"""
...
class StripeConfiguration(models.Model):
    """
    Singleton Stripe configuration model.
